...
const whatToWear = document.querySelector("#what-to-wear");
const commentsList = document.querySelector("#comments-list");
const commentForm = document.querySelector("f#new-comment");
...
function displayWeather(location, array) {
  ...
  let code = location.daily.weathercode[0];
    for (const item of array) {
      ...
      if (weatherReport.textContent.includes("Overcast" || "Cloudy")) {
      weatherImage.src = "https://www.rochesterfirst.com/wp-content/uploads/sites/66/2021/04/sky-1107579_1920.jpg?w=1752&h=769&crop=1";
      }
      if (weatherReport.textContent.includes("Rain" || "Drizzle")) {
      weatherImage.src = "https://www.denverpost.com/wp-content/uploads/2016/05/20160509__CD16WEATHER_AC25750xp1.jpg?w=654";
      }
      if (weatherReport.textContent.includes("Thunderstorm")) {
      weatherImage.src = "https://www.mercurynews.com/wp-content/uploads/2020/08/SJM-L-LIGHTNING-0817-11.jpg?w=810";
      }
      if (weatherReport.textContent.includes("Fog")) {
      weatherImage.src = "https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fspecials-images.forbesimg.com%2Fimageserve%2F603afd08b3400e3d1a7ba156%2FFog-Trucks%2F960x0.jpg%3Ffit%3Dscale";
      }
      if (weatherReport.textContent.includes("Clear")) {
      weatherImage.src = "https://lh3.googleusercontent.com/CnHg3skxcIhFKh5oE_ZV61x-a-tqWKIWC04a4hWkmQymuBRGlp3Kgnr_d3bEj-jgvPZAM1kh4nkpALUr0bDaUJdzPQ=w640-h400-e365-rj-sc0x00ffffff";
      }
      if (weatherReport.textContent.includes("Moderate Rain" || "Heavy Rain")) {
      weatherImage.src = "https://i.guim.co.uk/img/media/8132db117e863456488b553125383608d8c13264/0_265_2366_1419/master/2366.jpg?width=1200&height=1200&quality=85&auto=format&fit=crop&s=a646aa6afdee6cbea9460b4a660743ab";
      }
    }
...
function accordingToWeather(report) {
  if (report.textContent.includes("Snow")) {
    ...
    whatToWear.innerText = "Recommendation: If you plan on driving, go slow!"
